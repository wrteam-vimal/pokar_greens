...
/// a [CustomCheckbox] with a [WidgetStateProperty].
...
class CustomCheckbox extends StatefulWidget {
  ...
  /// Creates an adaptive [CustomCheckbox] based on whether the target platform is iOS
  ...
  WidgetStateProperty<Color?> get _widgetFillColor {
    return WidgetStateProperty.resolveWith((Set<WidgetState> states) {
      ...
      if (states.contains(WidgetState.selected)) {
        return widget.activeColor ?? ColorsRes.appColor;
      }
      return null;
    });
  }
...
// BEGIN GENERATED TOKEN PROPERTIES - CustomCheckbox
  ...
  WidgetStateBorderSide? get side {
    return WidgetStateBorderSide.resolveWith((Set<WidgetState> states) {
      if (states.contains(WidgetState.disabled)) {
        ...
        return BorderSide(
            width: 2.0, color: _colors.onSurface.withValues(alpha:0.38));
      }
      if (states.contains(WidgetState.selected)) {
      ...
      return BorderSide(width: 2.0, color: ColorsRes.subTitleMainTextColor);
    });
  }
...
// END GENERATED TOKEN PROPERTIES - CustomCheckbox
